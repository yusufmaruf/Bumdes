        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <div class="text-center mb-4">
                    <h3 class="address-title mb-2">Tambah Kategori Jenis Unit Usaha</h3>
                    <p class="text-muted address-subtitle">Silahkan masukan data tambah Kategori Jenis Unit Usaha</p>
                </div>
                <form id="addNewAddressForm" class="row g-3" action="{{ route('admin.categoryUnitUsaha.store') }}"
        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <form id="updatedata" class="row g-3" method="POST" novalidate enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <label class="form-label" for="modalAddressFirstName">Nama Kategori</label>
                        <input type="text" id="titleedit" name="name" class="form-control" />
                    </div>
                    <div class="col-12 text-center">
                        <button type="submit" class="btn btn-primary me-sm-3 me-1">Submit</button>
                        <button type="reset" class="btn btn-label-secondary" data-bs-dismiss="modal"
