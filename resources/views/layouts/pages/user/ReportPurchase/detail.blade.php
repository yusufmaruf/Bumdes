...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> Data Detail Transaksi Pengeluaran
        </h4>
        <!-- DataTable with Buttons -->
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Data Detail Transaksi Pengeluaran</h5>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('.table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('user.reportpurchaseuser.detail', $date) }}',
                    data: function(d) {
