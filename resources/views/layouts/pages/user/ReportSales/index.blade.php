        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Data Transaksi Penjualan</h5>
                    <a href="{{ route('user.reportsalesuser.create') }}" class="btn btn-vimeo ml-auto"><span
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('.table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('user.reportsalesuser.index') }}',
                    data: function(d) {
